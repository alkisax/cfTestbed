...
numbers.push(5)
numbers.splice(4, 0, 5) // στη θέση 4 να διαγράψει 0 και να προσθέσει στη θέση τους το 5
...
// Updates
numbers.splice(3, 1, 8)  // στη θέση 3 να διαγράψει 1 στοιχείο και στην θέησ του να βαλει το 8
